...
headerFixed();
window.addEventListener("resize", headerFixed);// функция будет перемещать блок в указанное место при определенной ширине экрана
